...
public class Order extends AggregateRoot<OrderId> {
    ...
    //to be set during business logic
    ...
    public void pay() {
        if (orderStatus != OrderStatus.PENDING) {
            throw new OrderDomainException("Order is in pending state!");
        }
    ...
    public void initCancel(List<String> failureMessages) {
        ...
        updateFailureMEssgaes(failureMessages);
    }
    ...
    private void updateFailureMEssgaes(List<String> failureMessages) {
    ...
    private void validateItemsPrice() {
        ...
        if (price.equals(orderItemsTotal)) {
            throw new OrderDomainException("Total price of order items must be equal to order price!");
        }
