package com.food.order.service.messaging.mapper;

import com.food.order.kafka.order.avro.model.PaymentOrderStatus;
import com.food.order.kafka.order.avro.model.PaymentRequestAvroModel;
import com.food.order.kafka.order.avro.model.PaymentResponseAvroModel;
import com.food.order.kafka.order.avro.model.RestaurantApprovalRequestAvroModel;
import com.food.order.kafka.order.avro.model.RestaurantApprovalResponseAvroModel;
import com.food.order.kafka.order.avro.model.RestaurantOrderStatus;
...
public class OrderMessagingDataMapper {
    ...
    orderPaidEventToRestaurantApprovalRequestAvroModel(OrderPaidEvent orderPaidEvent) {
        ...
        return RestaurantApprovalRequestAvroModel.newBuilder()
                ...
                .setOrderId(order.getId().getValue())
                .setRestaurantOrderStatus(com.food.order.kafka.order.avro.model.RestaurantOrderStatus
                        .valueOf(order.getOrderStatus().name()))
                .setProducts(order.getItems().stream().map(orderItem ->
                        com.food.order.kafka.order.avro.model.Product.newBuilder()
    ...
    public PaymentResponse paymentResponseAvroModelToPaymentResponse(PaymentResponseAvroModel
        ...
        return PaymentResponse.builder()
                ...
                .paymentStatus(com.food.order.domain.valueobject.PaymentStatus.valueOf(
    ...
    approvalResponseAvroModelToApprovalResponse(RestaurantApprovalResponseAvroModel
        ...
        return RestaurantApprovalResponse.builder()
                ...
                .orderApprovalStatus(com.food.order.domain.valueobject.OrderApprovalStatus.valueOf(
