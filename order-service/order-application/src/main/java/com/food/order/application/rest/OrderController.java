package com.food.order.application.rest;
...
public class OrderController {
    ...
    public ResponseEntity<CreateOrderResponse> createOrder(@RequestBody CreateOrderCommand createOrderCommand) {
        log.info("Creating order for customer: {} and restaurant: {}", createOrderCommand.getCustomerId(), createOrderCommand.getRestaurantId());
    ...
    public ResponseEntity<TrackOrderResponse> getOrderByTrackingId(@PathVariable UUID trackingId) {
        ...
        log.info("Retrning status of order with tracking id: {}", trackingId);
