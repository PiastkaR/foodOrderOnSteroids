...
public class RestaurantApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public RestaurantApprovalResponseAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID restaurantId, java.util.UUID orderId, java.time.Instant createdAt, com.food.order.kafka.order.avro.model.OrderApprovalStatus orderApprovalStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalResponseAvroModel>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.order.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.order.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.order.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setRestaurantId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.order.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setOrderId(java.util.UUID value) {
  ...
  public int hashCode() {
    ...
    result = 31 * result + (orderApprovalStatus == null ? 0 : ((java.lang.Enum) orderApprovalStatus).ordinal());
