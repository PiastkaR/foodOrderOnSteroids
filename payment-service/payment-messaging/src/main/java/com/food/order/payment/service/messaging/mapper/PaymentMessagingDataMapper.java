package com.food.order.payment.service.messaging.mapper;

import com.food.order.domain.valueobject.PaymentOrderStatus;
...
import com.food.order.kafka.order.avro.model.PaymentStatus;
